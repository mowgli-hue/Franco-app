...
const FOUNDATION_LESSONS = [
  ...
  mkL("f-02","Sounds of French",20,"listening",
    ...
    [mcq("How do you say cafe in French?",["KAF-ee","kaf-AY","KAY-fay","kaf-EE"],1,"Cafe = kaf-AY! The accent on e always makes the ay sound. You will see cafes everywhere in Quebec — now you know how to say it like a local!",1),
     ...
     wr("Write the French word for coffee",["cafe","café"],"Cafe! kaf-AY. One of the most common words in Quebec. Knowing how to say it correctly — with the ay sound at the end — shows you understand French pronunciation!",1)])mkL("f-03","Who Are You?",20,"speaking",
    ...
    [mcq("How do you say My name is in French?",["Je suis...","Je m'appelle...","J'ai...","J'habite..."],1,"Je m'appelle = My name is (literally I call myself). Always use this for your name — never Je suis name. This is the first phrase in every French introduction!",1),
     ...
     wr("Write a complete introduction in French with your name and where you live",["je m'appelle","j'habite","j'ai","je viens"],"Excellent! This introduction works at government offices, schools, job interviews, and meeting neighbours. You are ready for real Canadian life!",2)])mkL("f-04","Numbers That Matter",20,"listening",
    ...
    [mcq("What is trois in English?",["2","3","4","13"],1,"Trois = 3! Pronounced twah. The S is silent. You will hear this constantly: trois dollars, trois personnes, trois heures.",1),
     ...
     wr("Write the number 23 in French words",["vingt-trois","vingt trois"],"Vingt-trois! Vingt 20 plus trois 3. The hyphen is important in writing. Now you can write any number on Canadian forms!",2)])mkL("f-05","Your New Home",25,"mixed",
